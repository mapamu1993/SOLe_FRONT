        ...
        <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold text-[#333D29] tracking-tight">
              Explora la{" "}
              <span className="italic font-serif text-[#582F0E]">Tienda</span>
            </h1>
              ...
              products.map((product) => (
                ...
                >
                  ...
                  <Link
                    ...
                    className="block relative h-64 w-full overflow-hidden rounded-[2rem] bg-[#EBECE2]"
                  >
                    {product.image ? (
                      <img
