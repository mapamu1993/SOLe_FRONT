  ...
  return (
    <div 
      ...
      className={`
        min-h-screen 
        w-full 
        bg-[${BRAND_THEME.colors.background}] 
        font-sans 
        overflow-hidden
      `}
    >
      ...
      >
        ...
        >
          ...
          >
            <span className={BRAND_THEME.typography.eyebrow}>
              Desde 2024
            </span>
            <h1 
              className="
            ...
            >
              No hacemos <br/>
              mochilas, <br/>
              <span className="italic font-serif text-[#B6AD90]">
                creamos compañeros.
              </span>
            </h1>
            <p 
          ...
          >
            ...
            >
              ...
              <p className="text-xs font-serif italic">
                "El camino se hace andando, y mejor si vas ligero."
              </p>
            </motion.div>
          </motion.div>
        </div>
      ...
      <section className="py-20 px-6 text-center">
        ...
        >
          <h2 className={BRAND_THEME.typography.headingLg + " mb-6"}>
            ...
            <Link to="/tienda">
              <button 
                className={`
                  ...
                  overflow-hidden 
                  shadow-xl 
                  hover:shadow-[#B6AD90]/40 
                  transition-all 
                  active:scale-95 
                  ${BRAND_THEME.layout.borderRadius.button}
                `}
              >
                <span 
                  className="
  ...
  return (
    <motion.div 
      ...
      className={`
        ...
        border 
        border-transparent 
        hover:border-[#B6AD90]/30 
        hover:shadow-lg 
        transition-all 
        ${BRAND_THEME.layout.borderRadius.card}
      `}
    >
      <div 
        className="
      ...
      <h3 className="text-xl font-bold text-[#333D29] mb-3">
        {title}
      </h3>
  ...
  return (
    <motion.div 
      ...
      className={`
        ...
        ${
          isOpen 
            ? "bg-white border-[#582F0E] shadow-lg" 
            : "bg-white border-transparent hover:border-[#B6AD90]/50 shadow-sm"
        }
      `}
    >
      <button 
      ...
      >
        <span 
          className={`
            ...
            font-serif 
            transition-colors 
            ${isOpen ? "text-[#582F0E]" : "text-[#333D29]"}
          `}
        >
          {question}
        </span>
        <span 
          className={`
            ...
            rounded-full 
            transition-colors 
            ${isOpen ? "bg-[#582F0E] text-white" : "bg-[#F5F5F0] text-[#333D29]"}
          `}
        >
